...
HRESULT LightManager::Init(ID3D11Device* device, Camera* camera)
{
	...
	// point light shaders
	WCHAR pointShaderSrc[MAX_PATH] = L"..\\DeferredShader\\Shaders\\PointLight.hlsl";
	...
	WCHAR spotShaderSrc[MAX_PATH] = L"..\\DeferredShader\\Shaders\\SpotLight.hlsl";
	...
	WCHAR shadowgenSrc[MAX_PATH] = L"..\\DeferredShader\\Shaders\\ShadowGen.hlsl";
	...
	WCHAR commonSrc[MAX_PATH] = L"..\\DeferredShader\\Shaders\\Common.hlsl";
	...
	WCHAR shadowVisSrc[MAX_PATH] = L"..\\DeferredShader\\Shaders\\ShadowMapVisualize.hlsl";
